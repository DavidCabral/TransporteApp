...
begin
  FrmFiltroRelatorioCarteirinhas := TFrmFiltroRelatorioCarteirinhas.Create(Self);
  try
    FrmFiltroRelatorioCarteirinhas.ShowModal;
  finally
    FreeAndNil(FrmFiltroRelatorioCarteirinhas);
  end;
end;
