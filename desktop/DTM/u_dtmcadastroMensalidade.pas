...
begin
     try
       ...
       begin
         ...
         mensalidade.seg_ida := (Trim(qryMensalidade.FieldByName('SEG_IDA').AsString) = 'S');
         mensalidade.seg_volta := (Trim(qryMensalidade.FieldByName('SEG_VOLTA').AsString) = 'S');

         mensalidade.ter_ida := (Trim(qryMensalidade.FieldByName('TER_IDA').AsString) = 'S');
         mensalidade.ter_volta := (Trim(qryMensalidade.FieldByName('TER_VOLTA').AsString) = 'S');

         mensalidade.qua_ida := (Trim(qryMensalidade.FieldByName('QUA_IDA').AsString) = 'S');
         mensalidade.qua_volta := (Trim(qryMensalidade.FieldByName('QUA_VOLTA').AsString) = 'S');

         mensalidade.qui_ida := (Trim(qryMensalidade.FieldByName('QUI_IDA').AsString) = 'S');
         mensalidade.qui_volta := (Trim(qryMensalidade.FieldByName('QUI_VOLTA').AsString) = 'S');

         mensalidade.sex_ida := (Trim(qryMensalidade.FieldByName('SEX_IDA').AsString) = 'S');
         mensalidade.sex_volta := (Trim(qryMensalidade.FieldByName('SEX_VOLTA').AsString) = 'S');

         mensalidade.sab_ida := (Trim(qryMensalidade.FieldByName('SAB_IDA').AsString) = 'S');
         mensalidade.sab_volta := (Trim(qryMensalidade.FieldByName('SAB_VOLTA').AsString) = 'S');

         mensalidade.dom_ida := (Trim(qryMensalidade.FieldByName('DOM_IDA').AsString) = 'S');
         mensalidade.dom_volta := (Trim(qryMensalidade.FieldByName('DOM_VOLTA').AsString) = 'S');
